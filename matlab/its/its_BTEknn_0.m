...
%%% modified w.r.t. its_BTEknn.m - compensation for zero lag effects

function out=its_BTEknn_0(Y,V,ii,jj,k,metric)
...
i_YZ=i_Y;
for cni=1:length(ii)
%     i_YZ= i_YZ | (tmp==ii(cni) & V(:,2)~=0 ); %%% modification
