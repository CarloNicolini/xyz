...
%% VERSION WITH MULTIVARIATE (VECTOR) TARGET
% Computes the CMI between the first dimj columns of B and the last column of B, conditioned to the remaining columns

function [CMI]=its_CMIknn_V(B,dimj,k,metric)
...
A=B(:,1:end-1); % y and V
B2=B(:,dimj+1:end); % V and w
A2=A(:,dimj+1:end); % V alone
